...
export const common_executeScript = {   
    ...
    tabs_executeScript_indexOf: {
        a01: function (index, windowId, fileArr, code, html, isHighlightTab, next) {
            let oo = {
                index: index,
                windowId: windowId,
                html: html,
        ...
        a03: function (oo) {
            common.tabs_indexOf.a01(oo.index, oo.windowId, oo.html, this.a04, this, oo)//查找
        },
        a04: function (t, oo) {
    ...
    tabs_remove_create_indexOf: {
        ...
        a04: function (oo) {
            common.tabs_indexOf.a01(oo.index, oo.windowId, oo.html, this.a05, this, oo)//查找
        },
        a05: function (t, oo) {
            if (oo.isHighlightTab) {
                chrome.tabs.highlight({ tabs: 0, windowId: oo.windowId }, function ()//设置第一个【高亮tab】---这样执行速度快
    ...
    executeScript: {
        ...
        a02: function (id, oo) {
            if (oo.fileArr.length != 0) {
                let This = this;
                fetch(chrome.runtime.getURL("inject/jquery-3.6.3.min.js")).then(response => { return response.text(); }).then(str => {
                    // 处理返回的数据
                    This.a03(str, id, oo)
                })
            }
