Object.assign(Tool, {
    gatherDetail: {
        ...
        a02: function (oo) {
            ...
            $("#state").html("正在打开详情...");
            //Tool.ajax.text(url, this.a03, this, oo);------用这个不行
            //gg.getHtml(url, this.a03, this, oo)
            //gg.tabs_remove_create_getHeaders(2, url, [url], false, this.a03A, this,oo)
            let requestHeaders = [
                {
                    "name": "sec-ch-ua",
                ...
                {
                    "name": "Cookie",
                    "value": "arms_uid=b9f5e75b-774a-4e74-9820-e09f5e7a2a5b; _bl_uid=gjl3kuds2mtce5y4Fe6thtbnb6ty; lid=tb355675454277; ali_apache_track=c_mid=b2b-22130335979531b075|c_lid=tb355675454277|c_ms=1; ali_apache_tracktmp=c_w_signed=Y; mtop_partitioned_detect=1; _m_h5_tk=2f013844923be54f13f977afaeeaf2f9_1721192901479; _m_h5_tk_enc=0c99559401b47dc7fea2c7ac837ef502; cna=OBceHxkXMAgCAd+Sd7VHEs+l; xlly_s=1; x5sec=7b22733b32223a2231393133623166613764616166303962222c226c61707574613b32223a226530303261616434336461626238656632623235376139643437623363303537434c7a53334c5147454b6932397362352f2f2f2f2f774561447a49794d544d774d7a4d314f5463354e544d374d6a4432724b6b71227d; __cn_logon__=true; __cn_logon_id__=tb355675454277; last_mid=b2b-22130335979531b075; taklid=566b79def9d94e92966664d610eb4f8d; cookie1=BqtZm6xqNMh6HCk%2FY%2FVItMxIKeI9Q7vTMII5NHMpADY%3D; cookie2=162a60d0e8124c8232a1da0ef013cb56; cookie17=UUpgRSicxha%2BSTPQ1A%3D%3D; sgcookie=E100ZABut8Ud%2BkFV6nmKS%2FezzE%2FmSmAxKMmD5mgkTajAGCO8I07NW0v%2FJET2k8xu9QeG21LKcgq8ENOAxhCSiVHnpbgTDBGiyMpclAdirQqV2do%3D; t=e86ed6b6f4cf18790ad62da465a97f6f; _tb_token_=ee45853e7e9ee; sg=739; csg=13f67cc7; unb=2213033597953; uc4=id4=0%40U2gqykAlMZwdM7Qp%2BV05w%2BfdrTfMjbjB&nk4=0%40FY4NBmcEnJHAyCOJB4lFPGaO6UnfbrvWUA%3D%3D; _nk_=tb355675454277; _csrf_token=1721182759026; JSESSIONID=76064043C09671744E6A135726C1F4FD; isg=BNTUw8-hThDG8tkzHnCfq-5-pRJGLfgXJMJFEW6_qt-_WXCjlj8MpoqSWVFBoTBv; tfstk=fAyeeEqVe9BFhvVQgqMrusAIiVHLLxQXT8gSquqoA20HdpTu_0iXrUqlJzyrSvc8O4gIzYr8uG_fhtZLvYHhlZ6f0y1iXxLnrLYSsdm2QH4d3tZLvhxeriNGhQ8SWgIstAi3op5wTjb0DVVk5mXLOgQK1LvuKThEuginXDew8v34xJJwQGmETqqn7ZizuKcg2byJ2LlzxSU-myYhz4eajJV0oNOI-Sozc7rhKdDQpkVmZ-bJZkHI8A23g3vubvuQz8l28Nu0pl2xIf6c0l2TRkeaV3XofrggvJDPniHEK2DZX8_9K4PgZJGKeebryRrgK7SyXUnGq0e8TUArtcnZlGSw4rAz0D8Wz6RJwfDxbqsIAQd-tcnZlGSwwQhiDcufAD1.."
                }
            ]
            gg.setHeaders_getHtml(url, requestHeaders, this.a03, this, oo)
        },
        //a03A: function (t, oo) {
        //    Tool.pre(t)
        //},
        ...
        a04: function (t, oo) {
            let __INIT_DATA = Tool.StrSlice(t, ' window.__INIT_DATA=', ',"hasMoreModules"')
            if (__INIT_DATA) {
                let o1 = JSON.parse(__INIT_DATA + "}")
                let o2 = this.b02(o1.data);
                if (o2.error) {
        ...
        a05: function (oo) {
            ...
            if (detailUrl.indexOf("var=desc") == -1) {
                ...
                gg.getHtml(detailUrl, this.a06, this, oo);
            }
        },
        a06: function (t, oo) {
                   ...
                   if (data[k].data) {
                       let tmpObj = JSON.parse(data[k].data.offerDomain);
                        sku = {
                            ...
                            scale: tmpObj.tradeModel.scale ? tmpObj.tradeModel.scale : 1,//件倍数。每件的个数（如：100）
                            sellunit: tmpObj.tradeModel.sellunit ? tmpObj.tradeModel.sellunit:false,//销售单位（按包卖）
                        }
                    }
                    else {
                        return {
