...
var gg =
{
    ...
    tabs_executeScript_indexOf: function (index, fileArr, code, html, isHighlightTab, next, This, t) {
        let oo = { action: "tabs_executeScript_indexOf", index: index, fileArr: fileArr, code: code, html: html, isHighlightTab: isHighlightTab }
        this.postMessage(next, This, t, oo)
    },
