...
var fun =
{
    ...
    a01: function () {
        ...
        <div class="p-2">\
          ...
          <tbody>\
            ...
            <tr><td class="right">店铺ID：</td><td id="fromid" colspan="2"></td></tr>\
    ...
    d01: function () {
        let data = [{
            ...
            sql: "select " + Tool.fieldAs("fromid,unitweight,scale,discount,_1688_minimumorder,_1688_maxprice,_1688_freight,input_normal_price") + " FROM @.table" + Tool.limit(10, this.obj.A1, "sqlite"),
        }]
        if (this.obj.A2 == 0) {
            data.push({
                action: "sqlite",
