Object.assign(Tool, {
    ...
    b01: function () {
        ...
        // if (obj.arr[7] != "-_-20") { arr.push("@.BeforeReview=" + obj.arr[7]); }
        // if (obj.arr[8] != "-_-20") {
        //     switch (obj.arr[8]) {
        ...
        // if (obj.arr[10] != "-_-20") { arr.push("@.is" + obj.arr[10] + "=1"); }
    ...
    b06: function (val, I) {
        ...
        return '\
        <select onChange="fun.c03('+ I + ',this.options[this.selectedIndex].value)" class="form-select">\
    ...
    b10: function (val, I) {
        return '\
        <select onChange="Tool.c08('+ I + ',this.options[this.selectedIndex].value)" class="form-select">\
    ...
    b11: function (val, I, configArr) {
        ...
        return '\
        <select onChange="fun.c16('+ I + ',this.options[this.selectedIndex].value)" class="form-select">\
