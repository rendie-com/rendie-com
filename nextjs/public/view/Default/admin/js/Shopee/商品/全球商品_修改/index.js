...
var fun =
{
    a01: function () {
        ...
        // obj.arr[7] = obj.arr[7] ? obj.arr[7] : "-_-20";//更新前本地状态
        // obj.arr[8] = obj.arr[8] ? obj.arr[8] : "-_-20";//请选择【查询条件】
        // obj.arr[9] = obj.arr[9] ? obj.arr[9] : "-_-20";//修改状态
    ...
    a02: function () {
        ...
        let data = [{
            ...
            list: [{
                ...
                sql: "select @.attrPic_shopee as attrPic_shopee,@.sku as sku FROM @.prodes where @.fromid=${manualreview_1688_fromid}",
            }, {
                action: "sqlite",
		...
		<div class="p-2">\
			...
			<table class="table align-middle">\
				<thead class="table-light">\
                    ...
                    <tr>\
                        <td class="p-0">'+ Tool.b06("obj.arr[7]", 7) + '</td>\
                        <td class="p-0">' + Tool.b10("obj.arr[8]", 8) + '</td>\
                        <td class="p-0">' + Tool.b11("obj.arr[9]", 9, config.GlobalPro_editStatus_count) + '</td>\
            ...
            ' + Tool.page(t[0][0].total, 1, obj.params.page) + '\
		</div>'
