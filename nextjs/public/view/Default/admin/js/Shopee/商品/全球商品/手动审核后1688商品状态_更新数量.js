var fun =
{
    ...
    a01: function () {
        let html = Tool.header('Shopee &gt; 商品列表 &gt; 全球商品 &gt; 手动审核后1688商品状态_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let html = '<.Db(sqlite.shopee,select count(1) as total from @.GlobalPro where @.ManualReview_1688_state=' + (this.obj.A1 - 1) + ',count)/>'
        $("#state").html("正在统计数量");
