...
Object.assign(Tool, {
    release:
    {
        ...
        d05: function (oo) {
            ...
            gg.getHtml(url, this.d06, this, oo)
        },
        d06: function (o1, oo) {
            if (o1.code == 0) {
            ...
            for (let i = 0; i < search_data.model_list.length; i++) {
                model_price_list.push({
                    ...
                    mpsku_model_price: Tool.common_price.b03(
                        (parseFloat(search_data.model_list[i].price_info.normal_price) + GlobalPro.common_price.upPrice) * GlobalPro._1688_prodes_sku.scale,
                        oo.seller[oo.obj.site],
                        GlobalPro.discount
        ...
        e01: function (oo) {
            ...
            gg.postHtml(url, JSON.stringify(data), this.e02, this, oo)
        },
        e02: function (o1, oo) {
            let pArr = [
                "SPC_CDS=" + oo.seller.SPC_CDS,
            ...
            gg.postHtml(url, JSON.stringify(oo.GlobalPro[this.obj.B1 - 1].post), this.e03, this, oo)
        },
        e03: function (o1, oo) {
            if (o1.code == 0) {
                this.e04(oo);
        ...
        e05: function (oo) {
            ...
            $("#state").html("正在获取发布结果。。。");
            gg.getHtml(url, this.e06, this, oo)
        },
        e06: function (t, oo) {
            if (t.code == 0) {
                //说明:只要是发布成功，那就一定有进度条。
