...
var fun =
{
    ...
    a01: function () {
        let html = Tool.header(obj.params.return, "Shopee &gt; 商品列表 &gt; 全球商品 &gt; 更新前本地状态_更新商品") + '\
        <div class="p-2">\
    ...
    d06: function (oo) {
        if (oo.category.bindshopee == 0) {
            $("#state").html("没绑定类目");
            alert("aaaaaaa888888888888888aaaaaaaaa")
    ...
    e01: function (sku_shopee, oo) {
        if (typeof (sku_shopee) == "object") {
            ...
            gg.getHtml(url, this.e02, this, oo)
        }
        else {
    ...
    e02: function (o1, o2) {
        ...
        let descriptionArr = this.b09(o2.GlobalPro.manualreview_1688_description, o2.post.description, o2._1688_proList.unit, _1688_sku.scale, _1688_sku.sellunit)
        ////////////////////////////////////
    ...
    e03: function (data, GlobalPro) {
        ...
        str = str.replace(/亚马逊|东南亚|进口|欧美|出口|外贸|跨境|速卖通|wish|药|哦|logo|医|amazon/g, "")
        ...
        if (isBool) {
            ...
            $("#state").html("更新商品。。。")
            gg.postHtml(url, str, this.e04, this, GlobalPro);
        }
    },
