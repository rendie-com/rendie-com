var fun =
{
    ...
    d03: function (data, oo) {
        ...
        gg.postHtml(url, JSON.stringify(data), this.e01, this, oo)
    },
    //////////////////////////////////////////////////
    e01: function (t, oo) {
        ...
        $("#state").html("正在上传视频。。。");
        Tool.uploadFile.a01(url, [], data, this.e02, this, oo)
    },
    e02: function (t, oo) {
        if (t.x1) {
    ...
    e03: function (oo) {
        ...
        gg.postHtml(url, JSON.stringify(oo.post), this.e04, this, oo)
    },
    e04: function (t, oo) {
    ...
    f02: function (oo) {
        ...
        gg.postHtml(url, JSON.stringify(data), this.f03, this, oo)
    },
    f03: function (t, oo) {
        if (t.message == "success") {
