...
Object.assign(Tool, {
    loginShopee:
    {
        ...
        a04: function (oo) {
            ...
            gg.tabs_remove_create_indexOf(2, url, '<span> 登入 </span>', false, this.a05, this, oo);
        },
        a05: function (t, oo) {
            oo.dom.html("注入_登入");
            Tool.ajax.text("/" + o.path + "admin/js/Shopee/卖家账户/注入_登录.js", this.a06, this, oo);
        },
        a06: function (t, oo) {
        ...
        a07: function (t, oo) {
            if (t) {
                ...
                alert("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
                //this.a04(oo);
            }
        },
        a08: function (t, oo) {
        ...
        d03: function (oo) {
            ...
            gg.postHtml(url, null, this.d04, this, oo)
        },
        d04: function (t, oo) {
            if (t.status == "error") {
