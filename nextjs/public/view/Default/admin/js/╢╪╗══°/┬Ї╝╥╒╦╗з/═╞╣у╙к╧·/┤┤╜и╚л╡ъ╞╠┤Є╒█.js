...
var fun =
{
    ...
    a07: function () {
        ...
        gg.getHtml("https://seller.dhgate.com/promoweb/storediscount/storeDisActyList.do?ptype=1&dhpath=10004,3005", this.a08, this)
    },
    a08: function () {
        ...
        if (timeA == timeB) {
            ...
            gg.getHtml("http://seller.dhgate.com/promoweb/groupManage/groupList.do?dhpath=10004,30,3006", this.a09, this)
        }
        else {
    ...
    a09: function (str) {
        ...
        gg.postHtml(url, Tool.postData(o2), this.a10, this)
    },
    a10: function (oo) {
