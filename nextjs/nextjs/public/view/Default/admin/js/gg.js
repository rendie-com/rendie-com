...
var gg =
{
    ...
    postMessage: function (next, This, t, oo)//开始
    {
        if (this.obj.This == null) {
            oo.cmd = oo.cmd ? oo.cmd : 'content-script';
            oo.IDurl = Tool.urlToName(location.href)
    ...
    Return: function (txt)//返回
    {
        if (this.obj.windowId == 0) { this.obj.windowId = parseInt(txt); }//因为每次执行，都会用【gg.isRD】初始化,所以返回第一个值是定是【windowId】
        let next = this.obj.next, This = this.obj.This, t = this.obj.t;
        this.obj.next = null;
        this.obj.This = null;
        this.obj.t = null;
        next.apply(This, [txt, t]);
    },
    //////////////////////////////////////////////////////////////////////
    ...
    tabs_remove_create_indexOf: function (index, url, html, isHighlightTab, next, This, t) {
        let oo = { action: "tabs_remove_create_indexOf", index: index, url: url, html: html, isHighlightTab: isHighlightTab }
    ...
    //                                        gg.tabs_executeScript_indexOf(2,"js/jquery-3.6.3.min.js","执行代码","找到我就返回",true,this.c01,this,"xxxx")
    tabs_executeScript_indexOf: function (index, file, code, html, isHighlightTab, next, This, t) {
        let oo = { action: "tabs_executeScript_indexOf", index: index, file: file, code: code, html: html, isHighlightTab: isHighlightTab }
        this.postMessage(next, This, t, oo)
    },
   ...
   ////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////
    //gg.getHtml("https://www.aliexpress.com/item/1005002156462954.html",this.c01,this,t)
    getHtml: function (url, next, This, t) {
        let oo = { action: "getHtml", url: url }
        this.postMessage(next, This, t, oo)
    },
    //普通返回  gg.postHtml("https://www.aliexpress.com/item/1005002156462954.html",arr3,this.c01,this)
    postHtml: function (url, data, next, This, t) {
        let oo = { action: "postHtml", url: url, data: data }
        this.postMessage(next, This, t, oo)
    },
   ...
   上传文件       gg.uploadFile("https://rendie.com/ajax",[],[],this.a02,this,"xxxxx")
   可走Headers监听路线，比不修改“Origin”标头慢一点。
   */
...
//gg.resetProxy("fun.c01")
  ...
  //gg.tabs_remove_create_indexOf(2,"https://www.aliexpress.com/item/1005002156462954.html","aaaaaaaaaaaaa",this.c01,this,"xxxx")   无则创建有则更新再查找(返回网页内容)
  tabs_remove_create_indexOf:function(index,url,code,next) 
  {
    frame.postMessage({cmd: 'content-script',code: "fun.tabs_remove_create_indexOf("+index+",'"+url+"',decodeURI(\""+encodeURI(code)+"\"),'"+next+"',"+this.windowId+",'"+this.b01()+"')"}, '*'); 
  },
