...
var fun=
{
  ...
  a07:function()
    ...
    let num4=arr1[0].Num4?parseInt(arr1[0].Num4.replace(/\[|\]/g,"")):0
      ...
      gg.postHtml(url,JSON.stringify(arr3),this.a18,this)
		}
		else
		{
	...
	a08:function(str)
	{
      ...
      let arr3={isBlank:true,jsonstr:JSON.stringify(arr2)}
      gg.postHtml(url,JSON.stringify(arr3),this.a09,this)
		}
