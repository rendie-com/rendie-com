...
let F3=
{
  ...
  a02A:function()
    ...
    gg.postHtml(url,JSON.stringify(arr3),this.a05,this);
  },
	a05:function(str)
	{
  ...
  a09:function()
    ...
    gg.postHtml(url,JSON.stringify(arr3),this.a10,this); 
  },
  a10:function(str)
	{
  ...
  a11:function()
    ...
    let arr3={isBlank:true,jsonstr:JSON.stringify(arr2)}
    gg.postHtml(url,JSON.stringify(arr3),this.a12,this); 
  },
  a12:function(str)
	{
