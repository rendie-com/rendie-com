...
let F10 =
{
    ...
    a03: function (arr1) {
        ...
        $("#url").html('<a href="' + url + '" target="_blank">' + url + '</a>');
        gg.getHtml(url, this.a04, this)//服务能力分
    ...
    a04: function (arr1) {
        ...
        $("#url").html('<a href="' + url + '" target="_blank">' + url + '</a>');
        gg.getHtml(url, this.a05, this);//交易 
    },
    a05: function (arr1) {
    ...
    a06: function (t) {
        ...
        $("#url").html('<a href="' + url + '" target="_blank">' + url + '</a>');
        gg.getHtml(url, this.a07, this)//处罚管理 
    },
    a07: function (str) {
        $("#state").html("已打开【处罚管理】")
        if (str.indexOf("处罚详情</div>") != -1) {
            ...
            if (arr.length == 2) {
                ...
                $("#url").html('<a href="' + url + '" target="_blank">' + url + '</a>');
                gg.getHtml(url, this.a08, this)//管理产品 
            }
