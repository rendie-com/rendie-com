...
var fun =
{
  ...
  a20: function () {
    ...
    //gg.postHtml("http://seller.dhgate.com/syi/ajaxSavedraftboxV2.do?isblank=true&prodDraftId=850239260", this.b06(), this.a21, this);
    gg.postHtml("http://seller.dhgate.com/syi/save.do", this.b06(), this.a21, this);
  },
  a21: function (t) {
  ...
  a23: function (t, itemCode) {
    if (t == "") {
      $("#state").html("这条更新完成");
      gg.postHtml("http://seller.dhgate.com/prodmanage/audit/prodAudit.do?dhpath=10001,21001,0202", this.b10(itemCode), this.a24, this);
    }
    else {
      Tool.at("出错002："+t)
    }
