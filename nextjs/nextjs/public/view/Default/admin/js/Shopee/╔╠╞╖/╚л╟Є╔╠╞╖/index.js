...
var fun =
{
    a01: function () {
        ...
        // obj.arr[10] = obj.arr[10] ? obj.arr[10] : "-_-20";//手动审核后1688商品状态
    ...
    b01: function (type) {
        ...
        <tr>\
          ...
          <th class="p-0">'+ this.b13("obj.arr[10]", 10, config.GlobalPro_ManualReview_1688_state_count) + '</th>\
    ...
    b02: function () {
    	...
    	<ul class="dropdown-menu">\
            ...
            <li onClick="Tool.open4(\'?jsFile=js52\');" title="字段有：主推关键词、启用的关键词\n为什么要同步？答：方便删除后，再发布商品。"><a class="dropdown-item pointer">把【Shopee广告】中的关键词同步过来</a></li>\
            <li onClick="Tool.open4(\'?jsFile=js39\');"><a class="dropdown-item pointer">把速卖通的【折扣】同步过来</a></li>\
            <li onClick="Tool.open4(\'?jsFile=js26\');">\
...
">把1688的【手动审核1688状态】同步过来</a>\
    ...
    b13: function (val, I, configArr) {
        ...
        <select onChange="fun.c06('+ I + ',this.options[this.selectedIndex].value)" class="form-select">\
			<option value="-_-20">手动审核后1688商品状态</option>\
            <option value="-1">更新数量</option>\
            ' + nArr.join("") + '\
		</select>'
    },
    ...
    b17: function () {
        ...
        // if (obj.arr[10] != "-_-20") { arr.push("@.ManualReview_1688_state=" + obj.arr[10]); }
    ...
    c07: function (field, val) {
        if (confirm("确定要修改码？")) {
            let str = '"ok"<r: db="sqlite.shopee">update @.GlobalPro set @.BeforeReview=0,@.err=null where @.' + field + '=' + val + '</r:>'
