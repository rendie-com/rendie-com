var fun =
{
    ...
    a01: function () {
        let html = Tool.header('1688 &gt; 采集箱 &gt; 主商品列表 &gt; 手动审核1688状态_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let html = '<.Db(sqlite.1688,select count(1) as total from @.product where @.ManualReview_1688=' + (this.obj.A1 - 1) + ',count)/>'
        $("#state").html("正在统计数量");
